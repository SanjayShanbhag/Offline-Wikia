<?php
	...
	$srchquery = "http://gameofthrones.wikia.com/api/v1/Search/List?query=".$processedquery."&limit=25&minArticleQuality=10&batch=".$pg."&namespaces=0%2C14";
						...
						<div class="row">
							<div class="col-sm-12 col-md-8 col-lg-8">
								<?php
									...
									if($itemslength > 0){
										echo "<p>About ".$result['total']." results for ".$query." from Game of Thrones.</p><br>";
										foreach ($items as $item1) {
											...
											echo "<a style='color: #616161;' href='".$item1['url']."' target='_blank'>".$item1['url']."</a><br><br>";
											echo "</div>";
										}
									}else{
							...
							<div class="col-sm-12 col-md-4 col-lg-4">
								...
								<br>
								<?php
                                    $topjson = "http://gameofthrones.wikia.com/api/v1/Articles/Top?expand=1&limit=10";
                                    ...
                                    foreach ($items as $items1) {
                                        ...
                                        ?>
                                        <img src="<?php echo $image; ?>" onerror="this.src='../images/noimg.png'" width="100" height="100" style='float: left; margin-right: 5px; height: 80px;'>
                                        <?php
