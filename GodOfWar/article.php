...
<html>
<head>
	<title>God Of War Wikia</title>
	<link rel="stylesheet" type="text/css" href="/fandom/GodOfWar/CSS/style.css">
	<meta charset="utf-8">
    ...
    <script type="text/javascript">
        <?php
                $jsonurl1 = "http://godofwar.wikia.com/api/v1/Articles/Details?ids=".$id."&abstract=100&width=200&height=200";
...
<body onload="oload()">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" style="margin: 0; border: none; border-radius: 0;">
  			<div class="container-fluid">
    			...
    			<div class="collapse navbar-collapse" id="myNavbar">
      				<form class="navbar-form navbar-left" method="GET" action="/fandom/GodOfWar/searchresults.php">
		...
		<div class="container-fluid back">
			<div class="container">
                ...
                <div class="content">
                    <div class="topcon">
                        <img src="/fandom/GodOfWar/images/topfile.png" style="width: 300px; height: 90px; margin: auto;" class="center-block toplog">
                        <div class="toplog1" style="display: none; margin-top: top;">
                            <h3 style="text-align: center; color: #FAFAFA; margin-bottom: 0;">God Of War</h3>
                    ...
                    <div style="padding-left: 10px; padding-right: 10px;">
                        <div class="row">
                            <div class="col-sm-12 col-md-8 col-lg-8">
                                <?php
                                    if(!isset($id)){
                                        ...
                                        $url = "http://godofwar.wikia.com/api/v1/Articles/AsSimpleJson?id=".$id;
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                ...
                                <br>
                                <?php
                                    $topjson = "http://godofwar.wikia.com/api/v1/Articles/Top?expand=1&limit=10&baseArticleId=".$id;
                                    ...
                                    foreach ($items as $items1) {
                                        ...
                                        <?php
                                        echo "<a href='/fandom/GodOfWar/article.php/".$id1."'>".$title."</a><br>";
