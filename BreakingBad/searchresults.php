<?php
	...
	$srchquery = "http://breakingbad.wikia.com/api/v1/Search/List?query=".$processedquery."&limit=25&minArticleQuality=10&batch=".$pg."&namespaces=0%2C14";
						...
						<div class="row">
							<div class="col-sm-12 col-md-8 col-lg-8">
								<?php
									...
									if($itemslength > 0){
										echo "<p>About ".$result['total']." results for ".$query." from Breaking Bad.</p><br>";
										foreach ($items as $item1) {
							...
							<div class="col-sm-12 col-md-4 col-lg-4">
                                ...
                                <br>
								<?php
                                    $topjson = "http://breakingbad.wikia.com/api/v1/Articles/Top?expand=1&limit=10";
