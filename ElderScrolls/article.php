...
<div class="loader"></div>
		...
		<div class="container-fluid back">
			<div class="container">
                ...
                <div class="content">
                    <div class="topcon">
                        <img src="/fandom/ElderScrolls/images/topfile.png" style="width: 300px; height: 90px; margin: auto;" class="center-block toplog">
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                ...
                                <?php
                                    ...
                                    foreach ($items as $items1) {
                                        ...
                                        <?php
                                        echo "<a href='/fandom/ElderScrolls/article.php/".$id1."'>".$title."</a><br>";
