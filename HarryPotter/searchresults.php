<?php
	...
	$srchquery = "http://harrypotter.wikia.com/api/v1/Search/List?query=".$processedquery."&limit=25&minArticleQuality=10&batch=".$pg."&namespaces=0%2C14";
					...
					<div style="padding-left: 10px; padding-right: 10px;">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-4 col-lg-4">
								...
								<br>
								<?php
                                    $topjson = "http://harrypotter.wikia.com/api/v1/Articles/Top?expand=1&limit=10";
